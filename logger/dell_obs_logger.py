"""
DELL OBS Knative Event Function Module.
"""
import abc
import logging
import os
...
DEFAULT_LOG_FILE_NAME = "dell-obs-notifications-knative.log"
...
class DellOBSLogger(_Logger):
    _PREFIX = '[DellSwiftToS3MigrationModule] '
    ...
    def debug(self, msg):
        self.logger.debug(DellOBSLogger._PREFIX + msg)

    def info(self, msg):
        self.logger.info(DellOBSLogger._PREFIX + msg)

    def warning(self, msg):
        self.logger.warning(DellOBSLogger._PREFIX + msg)

    def error(self, msg):
        self.logger.error(DellOBSLogger._PREFIX + msg)
...
def get_logger(module_name=None, logging_level=logging.INFO, log_file=DEFAULT_LOG_FILE_NAME):
    ...
    """
    return DellOBSLogger(module_name, logging_level, log_file)